...
sfge::ext::Test_09_System::Test_09_System(Engine& engine) : System(engine)
{

}

void sfge::ext::Test_09_System::OnEngineInit()
{
...
void sfge::ext::Test_09_System::OnFixedUpdate()
{
...
void sfge::ext::Test_09_System::OnDraw()
{
...
void sfge::ext::Test_09_System::OnContact(ColliderData* c1, ColliderData* c2, bool enter)
{
	if (enter)
	{
